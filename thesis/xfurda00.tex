...
\projectinfo{
  ...
  title.cs={Generátor vědeckých webových portálů},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Scientific Web Portal Generator}, % název práce v angličtině / thesis title in english
