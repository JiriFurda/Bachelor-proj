...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{images/my-facet.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{images/my-modal.png}
	\caption{Modální okno s dalšími hodnoty fasety s názevem \uv{Part. Country}}
\end{figure}
%TODO doplnit cisla do obrazku
\begin{enumerate}
    \item Jméno fasety.
    \item Vstupní pole pro vyhledávání v hodnotách fasety.
    \item Fasetové hodnoty odpovídající hledané frázi z bodu 2. Výsledky se mění v reálném čase v závislosti na obsahu vstupního pole.
\end{enumerate}
