...
Tato kapitola popisuje experimenty pro zhodnocení výsledku práce. Část testování byla směřována přímo na uživatele a skládala se jak z implicitní, tak z explicitní zpětné vazby. V závěru kapitoly jsou diskutována možná vylepšení portálu do budoucna.

\section{Testování na uživatelích}
Do testování portálů uživatelů se zapojilo TODO uživatelů. Chování všech těchto uživatelů bylo sledováno pro vytvoření statistik používání. TODO z uživatelů navíc vyplnilo dotazník a tím poskytly přímé sdělení svého dojmu z portálu. 

\subsection{Dotazník uživatelského prožitku}
Dotazník se skládal z 26 otázek zaměřených na šest různých aspektů portálu. Tyto aspekty jsou atraktivnost, přesvědčivost, efektivita, spolehlivost, stimulaci a novotu. Na všechny otázky bylo možné odpovědět pomocí škály od 1 do 5, přičemž na každé straně škály byly postaveny vzájemně protikladné fráze zaměřené právě na jeden z uvedených aspektů. Respondent pomocí číselné škály volil, ke které frázi mají jeho pocity z portálu blíže.

Obsah dotazníku vycházel z UEQ\footnote{UEQ: \url{https://www.ueq-online.org/}} (\emph{User Experience Questionnaire}) a respondetům byl prezetován pomocí nástroje Google Formuláře\footnote{Google Formuláře: \url{https://www.google.com/intl/cs_CZ/forms/about/}}.
