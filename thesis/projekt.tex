...
\projectinfo{
  ...
  keywords.cs={Python, Elasticsearch, Vue, Flask, fasetové vyhledávání}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={Python, Elasticsearch, Vue, Flask, faceted search}, % klíčová slova v anglickém jazyce / keywords in english
...
\begin{document}
  ...
  \input{kapitoly/1-uvod}
  \input{kapitoly/2-rozbor}
  \input{kapitoly/3-implementace}
  \input{kapitoly/4-vyhodnoceni}
  \input{kapitoly/5-zaver}
