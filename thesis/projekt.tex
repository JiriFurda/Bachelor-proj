...
\projectinfo{
  ...
  keywords.cs={Python, Elasticsearch, Vue, Flask, facet}, % klíčová slova v českém či slovenském jazyce / keywords in czech or slovak language
  keywords.en={Python, Elasticsearch, Vue, Flask, facet}, % klíčová slova v anglickém jazyce / keywords in english
...
\begin{document}
  ...
  \input{kapitoly/2-dosavadni-stav}
  \input{kapitoly/3-soucasny-stav}
  \input{kapitoly/4-implementace}
